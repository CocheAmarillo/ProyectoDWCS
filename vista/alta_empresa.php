        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="nombre" name="nombre_emp" placeholder="" required>
                </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="email" class="form-control" name="email_emp" placeholder="exameple@gmail.com" required>
                </div>
                <div class="form-group col-md-2"></div>
                <div class="form-group col-md-4">
                    <label for="">Phone Number:</label>
                    <input type="text" class="form-control" name="telefono_emp" placeholder="(+34) 123 456 789" required>
                </div>
                <div class="form-group col-md-1"></div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" name="codigo_postal_emp" placeholder="" required>
                </div>
                <div class="form-group col-md-2"></div>
                <div class="form-group col-md-4">
                    <label for="">Address:</label>
                    <input type="text" class="form-control" name="direccion_emp" placeholder="Company Address" required>
                </div>
                <div class="form-group col-md-1"></div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    <label for="">Name:</label>
                    <input type="text" class="form-control" name="nombre_resp" placeholder="" required>
                </div>
                <div class="form-group col-md-2"></div>
                <div class="form-group col-md-4">
                    <label for="">Email:</label>
                    <input type="email" class="form-control" name="email_resp" placeholder="example@gmail.com" required>
                </div>
                <div class="form-group col-md-1"></div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    <label for="">Phone Number:</label>
                    <input type="text" class="form-control" name="telefono_resp" placeholder="(+34) 123 456 789">
                </div>
                <div class="form-group col-md-2"></div>
                <div class="form-group col-md-4">
